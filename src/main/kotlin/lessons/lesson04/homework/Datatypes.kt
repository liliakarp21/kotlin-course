...
// значения для Boolean пишутся маленькими буквами, для String не хватает двойных кавычек:
//val v6= FALSE
val v7: Char = 'c'
val v8: Int = 500
...
val v19: Float = 5.75f
//в одинарных кавычках укзывается тип Char - одиночный символ, здесь несколько символов
//val v20 = `1.414`
val v21: String = "Artificial Intelligence"
//в массиве записаны значения для разных типов переменных - Char и String
//val v22= arrayOf('x', "A")
...
//смайлик не может быть строкой
//val v32 = “🤯”
val v33: Map<String, Int> = mapOf("true" to 2, "false" to 34)
//в одинарных кавычках укзывается тип Char - одиночный символ, здесь несколько символов, нужны двойные кавычка как String
//val v34 = ‘65535’
...
//Byte - Хранить количество ложек сахара, которые я кладу в одну чашку чая.
//Int - Хранить список расходов на доставку еды, чтобы ещё раз убедиться, что готовить было дешевле.
//Float - Хранить длину очереди в столовой до миллиардной доли сантиметра.
...
//Int - Хранить количество нажатий котом на клавиатуру ноутбука за всё время твоей работы.
//Long - Хранить количество попыток пересчитать звёзды на небе за всю историю человечества.
//Double - Хранить массу воздуха в спускающем матрасе после нападения кота в долях грамма.
//Map<String, Float> Хранить словарь «название стартапа → сумму потерь инвесторов».
